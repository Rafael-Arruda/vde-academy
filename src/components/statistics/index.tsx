...
export function Statistics() {
    ...
    const [disciplines, setDisciplines] = useState<number>(0);
                    ...
                    <div className="w-full flex flex-col justify-between rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] md:p-6">
                        ...
                        <div className="flex items-end justify-between mt-5">
                            <div>
                                ...
                                <h3 className="mt-1 text-2xl font-bold text-gray-800 text-title-sm dark:text-white/90">
                                    {totalTime === 0? "calculando..." : formatTime(totalTime)}
                                </h3>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="w-full flex flex-col justify-between rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] md:p-6">
                        ...
                        <div className="flex items-end justify-between mt-5">
                            <div>
                                ...
                                <h3 className="mt-1 text-2xl font-bold text-gray-800 text-title-sm dark:text-white/90">
                                    {disciplines === 0? "calculando..." : disciplines}
                                </h3>
                            </div>
                        </div>
                    </div>
